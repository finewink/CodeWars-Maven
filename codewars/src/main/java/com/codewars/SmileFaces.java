 ...
 * or ; A smiley face can have a nose but it does not have to. Valid characters
 * for a nose are - or ~ Every smiling face must have a smiling mouth that
 * should be marked with either ) or D No additional characters are allowed
 ...
 * countSmileys([';]', ':[', ';*', ':$', ';-D']); // should return 1; Note In
 * case of an empty array return 0. You will not be tested with invalid input
